        ...
        <div className="w-full lg:w-2/3 flex flex-col items-center">
          ...
          <div className="w-full flex flex-col lg:flex-row items-center gap-6">
           ...
           <p className="text-center lg:text-left text-gray-700 dark:text-gray-300 max-w-md lg:max-w-2xl">
            I'm a self-learned developer from Kenya. I'm still a student, currently in third year school of Business and economics taking Bachelor of Business Management at Moi University - Eldoret. <br />
